...
int solve_1(int day, int buy, vector<int> &prices, int n)
{
    ...
    { // not allowed to buy but allowed to sell
        int Sell = prices[day] + solve_1(day + 1, 0, prices, n);
...
int solve_2(int day, int buy, vector<int> &prices, int n, vector<vector<int>> &dp)
{
    ...
    { // not allowed to buy but allowed to sell
        int Sell = prices[day] + solve_2(day + 1, 0, prices, n, dp);
...
// https://leetcode.com/problems/best-time-to-buy-and-sell-stock-ii/submissions/1275160572/
int main()
{
